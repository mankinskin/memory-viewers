# Session Objective
Resolve the current static_complexity batch for memory-viewers and reduce 7 findings from the baseline.

# Scope Guardrails
- Stay inside memory-viewers unless a blocker requires a dependency fix outside scope.
